...
const projects: Project[] = [
  {
    ...
    title: "Config-Driven Form Engine",
    src: "/assets/projects-screenshots/form-engine/1.png",
    screenshots: ["1.png"],
  ...
  {
    id: "saison-international",
    category: "Corporate Websites",
    title: "Saison International Websites",
    src: "/assets/projects-screenshots/saison/1.png",
    screenshots: ["1.png"],
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
            Saison International Corporate Websites
          </TypographyP>
          <TypographyP className="font-mono ">
  ...
  {
    id: "loan-disbursement-sdk",
    category: "Fintech SDK",
    title: "Loan Disbursement SDK",
    src: "/assets/projects-screenshots/loan-sdk/1.png",
    screenshots: ["1.png"],
    live: "https://saison-omni.com",
    skills: {
      frontend: [
  ...
  },
  {
    ...
    src: "/assets/projects-screenshots/component-lib/1.png",
    screenshots: ["1.png"],
    live: "https://saison-omni.com",
    skills: {
      frontend: [
  ...
  },
  {
    ...
    src: "/assets/projects-screenshots/dms/1.png",
    screenshots: ["1.png"],
    live: "https://saison-omni.com",
    skills: {
      frontend: [
  ...
  },
  {
    ...
    title: "Web3 SaaS Platforms",
    src: "/assets/projects-screenshots/web3/1.png",
    screenshots: ["1.png"],
    live: "https://unicus.one",
  ...
  // Previous projects commented out
  // {
  //   id: "codingducks",
