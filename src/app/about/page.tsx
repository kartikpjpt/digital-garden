          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Kartik Prajapat</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Kartik Prajapat, a Product-obsessed Full Stack Engineer with 4+ years of experience building scalable,
              enterprise-grade systems and high-performance user interfaces. I have a proven track record of taking ownership from concept
              to deployment in both startup and fintech environments.
            </p>
            <p className="mb-10">
              My expertise lies in React, TypeScript, Node.js, and Java, with a focus on optimizing complex data pipelines and automating
              decision workflows. Currently working as a Senior Software Engineer II at Saison Omni in Bangalore, where I&apos;ve engineered
              config-driven form engines, architected monorepos, and built SDKs serving 1Cr+ daily users.
            </p>
            <p className="mb-10">
              I&apos;m passionate about solving offline-world problems through innovative technology, whether it&apos;s building Web3 platforms,
              optimizing performance, or creating developer tools that empower teams to ship faster.
            </p>
